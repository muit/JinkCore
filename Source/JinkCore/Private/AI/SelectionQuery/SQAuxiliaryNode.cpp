...
#include "SelectionQuery/BTCompositeNode.h"
#include "SelectionQuery/BTAuxiliaryNode.h"
...
void UBTAuxiliaryNode::WrappedOnBecomeRelevant(USelectionQueryComponent& OwnerComp, uint8* NodeMemory) const
{
...
void UBTAuxiliaryNode::WrappedOnCeaseRelevant(USelectionQueryComponent& OwnerComp, uint8* NodeMemory) const
{
...
void UBTAuxiliaryNode::WrappedTickNode(USelectionQueryComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds) const
{
...
void UBTAuxiliaryNode::DescribeRuntimeValues(const USelectionQueryComponent& OwnerComp, uint8* NodeMemory, EBTDescriptionVerbosity::Type Verbosity, TArray<FString>& Values) const
{
...
void UBTAuxiliaryNode::OnBecomeRelevant(USelectionQueryComponent& OwnerComp, uint8* NodeMemory)
{
	// empty in base class
}

void UBTAuxiliaryNode::OnCeaseRelevant(USelectionQueryComponent& OwnerComp, uint8* NodeMemory)
{
	// empty in base class
}

void UBTAuxiliaryNode::TickNode(USelectionQueryComponent& OwnerComp, uint8* NodeMemory, float DeltaSeconds)
{
	// empty in base class
}
