...
public:
	...
	virtual TSharedRef<ISelectionQueryEditor> CreateSelectionQueryEditor( const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, class UEnvQuery* Query );
